                  ...
                  {purchase.status === 'pending' && (
                    <>
                      <button
                        ...
                        className={`${approvingId === purchase.id ? 'opacity-50 cursor-not-allowed' : 'text-green-600 hover:text-green-900'}`}
                        title="Approve"
                      >
                        {approvingId === purchase.id ? (
                      ...
                      <button
                        ...
                        disabled={approvingId === purchase.id}
                        className={`${approvingId === purchase.id ? 'opacity-50 cursor-not-allowed' : 'text-red-600 hover:text-red-900'}`}
                        title="Reject"
                      >
                        <FaTimes />
                      </button>
                  ...
                  {purchase.status === 'pending' && (
                    <>
                      <button
                        onClick={() => handleApprove(purchase)}
                        disabled={approvingId === purchase.id}
                        className={`p-2 ${approvingId === purchase.id ? 'opacity-50 cursor-not-allowed' : 'text-green-600 hover:text-green-900'}`}
                        title="Approve"
                      >
                        {approvingId === purchase.id ? (
                          <svg className="animate-spin h-4 w-4 text-green-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <button
                        onClick={() => handleReject(purchase.id)}
                        disabled={approvingId === purchase.id}
                        className={`p-2 ${approvingId === purchase.id ? 'opacity-50 cursor-not-allowed' : 'text-red-600 hover:text-red-900'}`}
                        title="Reject"
                      >
