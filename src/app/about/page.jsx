    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 text-black">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-200/20 to-cyan-200/20 mix-blend-overlay"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="relative">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-purple-200/50 to-transparent rounded-2xl"></div>
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-center lg:justify-start space-x-4 mt-4">
                        <a href="#" className="text-gray-600 hover:text-cyan-600 transition-colors text-2xl">💼</a>
                        <a href="#" className="text-gray-600 hover:text-cyan-600 transition-colors text-2xl">🐦</a>
                        <a href="#" className="text-gray-600 hover:text-cyan-600 transition-colors text-2xl">📘</a>
                      </div>
                    </div>
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="text-center bg-gray-100 rounded-lg p-4">
                        ...
                        <div className="text-gray-600 text-sm">Courses Created</div>
                      </div>
                      <div className="text-center bg-gray-100 rounded-lg p-4">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="group bg-white backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="relative h-64">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-purple-200/50 to-transparent"></div>
                  <div className="absolute top-6 left-6">
                    <div className="text-4xl bg-cyan-100 backdrop-blur-sm rounded-lg p-3">🎯</div>
                  </div>
                </div>
                <div className="p-8">
                  <h3 className="text-3xl font-bold text-black mb-6 text-center">Our Mission</h3>
              ...
              <div className="group bg-white backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="relative h-64">
                  ...
                  <div className="absolute top-6 left-6">
                    <div className="text-4xl bg-purple-100 backdrop-blur-sm rounded-lg p-3">🔮</div>
                  </div>
                </div>
                <div className="p-8">
                  <h3 className="text-3xl font-bold text-black mb-6 text-center">Our Vision</h3>
                  <p className="text-gray-700 leading-relaxed text-center text-lg">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group bg-white backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-200">
                  <div className="relative h-48">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="text-3xl bg-cyan-100 backdrop-blur-sm rounded-lg p-2 group-hover:scale-110 transition-transform">
                        {feature.icon}
                      </div>
                    </div>
                  </div>
              ...
              <div>
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Expert-Led Learning</h3>
                      <p className="text-gray-700">Learn from industry experts who bring real-world experience and cutting-edge knowledge to every lesson.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Hands-On Practice</h3>
                      <p className="text-gray-700">Apply what you learn through practical projects and real-world scenarios that build confidence and skills.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-black mb-2">Career Transformation</h3>
                      <p className="text-gray-700">Get personalized career guidance and industry connections to accelerate your professional growth.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center bg-white backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
